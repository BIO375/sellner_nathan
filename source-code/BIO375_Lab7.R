...
model101_b <- aov(growth.rate ~ parasite, daphnia)
TukeyHSD(model101_b)
...
# It would be inappropriate because the readings from the gas chromatograph are taken
# from the same mason jar and so there is nothing that is independent about the 3 samples 
# and so they are not independent of each other. The authors treated these readings as 
# procedural reps and not independent observations
